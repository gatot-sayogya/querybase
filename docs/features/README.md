...
### 1. [Schema Browser](../user-guide/schema-browser.md)

**Database Schema Inspection**

Comprehensive implementation documentation and user guide for:

- Real-time schema loading
- Table and column exploration
- Visual indicators (PK, FK)
- WebSocket integration
- API endpoints

### 2. [EXPLAIN and Dry Run](explain-dryrun.md)
...
### 3. [Encrypted Frontend-Backend Communication](ENCRYPTED_COMMUNICATION.md) ✨ PLANNED
...
- [Query Features Guide](../user-guide/query-features.md) - Comprehensive user guide

## See Also

- [user-guide/query-features.md](../user-guide/query-features.md) - Complete feature guide
- [architecture/flow.md](../architecture/flow.md) - Visual flow diagrams
